...
import {
  ...
  import { MdOutlineBatteryUnknown, MdOutlineMemory, MdScreenshot } from 'react-icons/md';
  import './styles.css';
    ...
    return (
      <Box maxW="7xl" mx={"auto"} pt={5} px={{ base: 2, sm: 12, md: 17 }}>
        ...
        >
          ...
          <div className='test'><Image alt="asd" src={products.avatarUrl} width={500} height={500} /></div>
        </chakra.h1>
